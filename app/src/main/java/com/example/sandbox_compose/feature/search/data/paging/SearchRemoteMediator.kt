package com.example.sandbox_compose.feature.search.data.paging
...
import com.example.sandbox_compose.feature.search.data.remote.model.toSearchDto
                ...
                database.apply {
                    ...
                    searchArticleDao().insertAllSearchArticles(
                           articles = searchArticle.map {
                               it.toSearchDto(page, Constants.SEARCH_CATEGORY)
                           }
                    )
                }
            }
